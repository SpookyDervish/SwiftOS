...
void Desktop::Draw(common::GraphicsContext *gc)
{
    ...
    gc->DrawText("Let's go! We have text!", 1, 1, 0xff, 0xff, 0xff, 1, 1);
...
void Desktop::OnMouseDown(swiftos::common::uint8_t button)
{
    CompositeWidget::OnMouseDown(MouseX, MouseY, button);
}

void Desktop::OnMouseUp(swiftos::common::uint8_t button)
{
