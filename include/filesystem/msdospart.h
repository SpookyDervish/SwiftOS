#ifndef __SWIFTOS__FILESYSTEM__MSDOSPART_H
#define __SWIFTOS__FILESYSTEM__MSDOSPART_H
...
struct MasterBootRecord
{
    ...
    PartionTableEntry primaryPartition[4];
...
{
  public:
    static void ReadPartitions(swiftos::drivers::AdvancedTechnologyAttachment *hd);
};
} // namespace filesystem
